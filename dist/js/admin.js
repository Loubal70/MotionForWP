...
/* harmony export */   "motionHooks": () => (/* binding */ motionHooks)
/* harmony export */ });
...
function motionHooks() {
  return {
    ...
    addFilters: function addFilters() {
      wp.hooks.addFilter('blocks.registerBlockType', "".concat(this.namespace, "/custom-attributes"), this.addAttributes);
      wp.hooks.addFilter('editor.BlockEdit', "".concat(this.namespace, "/advanced-control"), this.addAdvancedControls);
      wp.hooks.addFilter('blocks.getSaveContent.extraProps', "".concat(this.namespace, "/extra-props"), this.addExtraProps);
    },
    addAttributes: function addAttributes(settings, name) {
    ...
    addAdvancedControls: createHigherOrderComponent(function (BlockEdit) {
      return /*#__PURE__*/function (_Component) {
        _inherits(BlockEditWithMotion, _Component);
        var _super = _createSuper(BlockEditWithMotion);
        function BlockEditWithMotion(props) {
          var _this;
          _classCallCheck(this, BlockEditWithMotion);
        ...
        return BlockEditWithMotion;
      }(Component);
    }, 'addAdvancedControls'),
    addExtraProps: function addExtraProps(props, blockType, attributes) {
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hooks_hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hooks/hooks */ "./resources/js/hooks/hooks.js");

(0,_hooks_hooks__WEBPACK_IMPORTED_MODULE_0__.motionHooks)().register();
})();
